    ...
    <div class="row mt-3">
        <div class="col-12 my-auto">
            <div class="row d-flex justify-content-between bg-dark text-light rounded-top">
                ...
                <p class="m-2"><span class="badge badge-info m-2 p-2"><?= $aPost->type()?></span><a href="index.php?action=updatePost&amp;id=<?= $aPost->id()?>" class="btn btn-outline-light btn-sm">Modifier</a></p>
            </div>
            <div class="row">
